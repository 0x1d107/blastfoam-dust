...
scalar b1(scalar alpha){
	return  (1.0-alpha) * log(1-alpha);
}
scalar b2(scalar alpha,scalar alpha0){
	return  (1+log(1-alpha0))*(alpha - alpha0);
}
template <class Thermo> scalar Foam::saurelFluidBlastThermo<Thermo>::beta(scalar alpha, scalar rho) const {
...
void Foam::saurelFluidBlastThermo<Thermo>::calculate()
{
...
)
{
    ...
    forAll(alpha, celli)
    {
        ...
        if (vfi > this->residualAlpha_.value())
        {
            ...
            pXiSum[celli] += (t.p(rhoi, ei, Ti)+beta(alphai,rhoi))*Xii;
            XiSum[celli] += Xii;
        }
    }
    ...
    forAll(alpha.boundaryField(), patchi)
    {
        ...
        forAll(palpha, facei)
        {
            ...
            if (alphai > this->residualAlpha_.value())
            {
                ...
                ppXiSum[facei] = (t.p(rhoi, ei, Ti)+beta(alphai,rhoi))*Xii;
...
template<class Thermo>
void Foam::saurelFluidBlastThermo<Thermo>::calculateSpeedOfSound
(
    const volScalarField& alpha,
...
)
{
    ...
    forAll(this->T_.boundaryField(), patchi)
    {
        ...
        forAll(pT, facei)
        {
            ...
            {
                pcSqrRhoXiSum[facei] +=
                    (dBdAlpha(palpha[facei])+t.cSqr(pp[facei], prho[facei], phe[facei], pT[facei]))
...
template<class Thermo>
Foam::saurelFluidBlastThermo<Thermo>::saurelFluidBlastThermo
(
    const fvMesh& mesh,
...
template<class Thermo>
void Foam::saurelFluidBlastThermo<Thermo>::correct()
{
    if (debug)
    {
        InfoInFunction << endl;
...
template<class Thermo>
void Foam::saurelFluidBlastThermo<Thermo>::updateRho(const volScalarField& p)
{
...
template<class Thermo>
void Foam::saurelFluidBlastThermo<Thermo>::updateRho
(
    const volScalarField& alpha,
...
Foam::saurelFluidBlastThermo<Thermo>::ESource() const
{
...
template<class Thermo>
Foam::tmp<Foam::volScalarField>
Foam::saurelFluidBlastThermo<Thermo>::initESource() const
{
    return tmp<volScalarField>
    (
        volScalarField::New
...
template<class Thermo>
Foam::tmp<Foam::volScalarField>
Foam::saurelFluidBlastThermo<Thermo>::Gamma() const
{
...
template<class Thermo>
Foam::scalar
Foam::saurelFluidBlastThermo<Thermo>::cellGamma(const label celli) const
{
...
template<class Thermo>
Foam::scalar Foam::saurelFluidBlastThermo<Thermo>::cellpRhoT
(
    const label celli,
    const bool limit
) const
...
template<class Thermo>
Foam::scalar
Foam::saurelFluidBlastThermo<Thermo>::celldpdRho(const label celli) const
{
...
template<class Thermo>
Foam::scalar
Foam::saurelFluidBlastThermo<Thermo>::celldpde(const label celli) const
{
...
template<class Thermo>
Foam::scalar
Foam::saurelFluidBlastThermo<Thermo>::celldpdT(const label celli) const
{
...
template<class Thermo>
Foam::tmp<Foam::volScalarField>
Foam::saurelFluidBlastThermo<Thermo>::calce(const volScalarField& p) const
{
    return Thermo::volScalarFieldProperty
    (
        "e",
...
template<class Thermo>
Foam::scalar
Foam::saurelFluidBlastThermo<Thermo>::calcCelle
(
    const scalar p,
    const label celli
) const
...
template<class Thermo>
Foam::tmp<Foam::volScalarField>
Foam::saurelFluidBlastThermo<Thermo>::calcp() const
{
    return Thermo::volScalarFieldProperty
    (
        "p",
...
template<class Thermo>
Foam::tmp<Foam::volScalarField>
Foam::saurelFluidBlastThermo<Thermo>::calcSpeedOfSound() const
{
